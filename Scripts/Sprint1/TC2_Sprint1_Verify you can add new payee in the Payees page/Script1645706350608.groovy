...
WebUI.callTestCase(findTestCase('Common/SearchPayee'), [('searchPayee') : searchPayee], FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Payees/searchPayeeResult_txt', [('payeeName') : payeeName, ('payeeAccount') : payeeAccount]), 
    GlobalVariable.mediumWait)
